...
/** Response for listing table summaries. */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ListTableSummaryResponse implements PagedResponse<TableSummary> {

    private static final String FIELD_TABLE_SUMMARIES = "tableSummaries";
    private static final String FIELD_NEXT_PAGE_TOKEN = "nextPageToken";

    @JsonProperty(FIELD_TABLE_SUMMARIES)
    private final List<TableSummary> tableSummaries;

    @JsonProperty(FIELD_NEXT_PAGE_TOKEN)
    private final String nextPageToken;

    public ListTableSummaryResponse(
            @JsonProperty(FIELD_TABLE_SUMMARIES) List<TableSummary> tableSummaries) {
    ...
    @JsonGetter(FIELD_TABLE_SUMMARIES)
