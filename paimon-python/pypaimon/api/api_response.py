...
class GetFunctionResponse(AuditRESTResponse):
    ...
    return_params: Optional[List] = json_field(FIELD_RETURN_PARAMS, default=None)
    deterministic: bool = json_field(FIELD_DETERMINISTIC, default=False)
    definitions: Optional[Dict] = json_field(FIELD_DEFINITIONS, default=None)
    ...
    def __init__(
        ...
        return_params: Optional[List] = None,
    ...
    def from_dict(cls, data: Dict) -> "GetFunctionResponse":
        return cls(
            ...
            return_params=data.get("returnParams"),
    ...
    def to_dict(self) -> Dict:
        ...
        result["returnParams"] = self.return_params
