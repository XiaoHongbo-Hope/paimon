...
class FileStoreCommit:
    ...
    def __init__(self, snapshot_commit: SnapshotCommit, table, commit_user: str):
        ...
        self.commit_max_retries = CoreOptions.commit_max_retries(table.options.options.to_map())
        self.commit_timeout = CoreOptions.commit_timeout(table.options.options.to_map())
        self.commit_min_retry_wait = CoreOptions.commit_min_retry_wait(table.options.options.to_map())
        self.commit_max_retry_wait = CoreOptions.commit_max_retry_wait(table.options.options.to_map())
